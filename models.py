...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if self.hazardous:     #True = 'is',  False = 'is not'
            ...
            haz = 'is not'
        return f"A NearEarthObject '{self.fullname}' has a diameter of {self.diameter:.3f} km and {haz} hazardous."
...
class CloseApproach:
    ...
    # TODO: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, designation, time = None, distance = 0.0, velocity = 0.0, name = None):
        ...
        self.time = cd_to_datetime(str(time))  # TODO: Use the cd_to_datetime function for this attribute.
    ...
    def __repr__(self):
        """Return `repr(self)`, a computer-readable string representation of this object."""
        return (f"CloseApproach(_designation={self._designation!r},time={self.time_str!r}, distance={self.distance:.2f}, "
